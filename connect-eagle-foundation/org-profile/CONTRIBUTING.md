...
[Start here](https://github.com/CONNECT-EAGLE/testrepo/blob/main/START_HERE.md) · [Find work](https://github.com/CONNECT-EAGLE/testrepo/blob/main/OPPORTUNITIES.md) · [Ask a question](https://github.com/CONNECT-EAGLE/testrepo/blob/main/COMMUNITY.md)
...
1. Choose an open issue from [Opportunities](https://github.com/CONNECT-EAGLE/testrepo/blob/main/OPPORTUNITIES.md). Check its assignee, comments, and linked PRs.
...
| CLI or registry code | Run the relevant tests; follow the [CLI development guide](https://github.com/CONNECT-EAGLE/testrepo/blob/main/connect-eagle-foundation/connect-eagle-cli/README.md#development) |
| Project registration | Validate the record and regenerate the directory as described in [Submit a project](https://github.com/CONNECT-EAGLE/testrepo/blob/main/SUBMIT_PROJECT.md) |
...
This is a small volunteer community with no guaranteed response time. After seven days without a response, one polite follow-up in the same thread is appropriate. Do not send repeated personal messages. Use [Community](https://github.com/CONNECT-EAGLE/testrepo/blob/main/COMMUNITY.md) for general questions.

## Credit and conduct

Credit code and non-code work through linked PRs, review acknowledgments, and project-specific citations. Ask before listing another person. See [Credits](https://github.com/CONNECT-EAGLE/testrepo/blob/main/CONTRIBUTORS.md) and [Code of conduct](https://github.com/CONNECT-EAGLE/testrepo/blob/main/CODE_OF_CONDUCT.md). Contributing here does not create NASA affiliation or automatically confer paper authorship.
